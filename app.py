...
MASTER_SUBJECTS = ["MATHEMATICS", "ENGLISH", "BIOLOGY", "PHYSICS", "CHEMISTRY", "ECONOMICS", "GOVERNMENT", "LITERATURE", "CIVIC EDUCATION", "COMMERCE", "AGRIC SCIENCE", "GEOGRAPHY", "CRS", "IRS", "HISTORY", "COMPUTER STUDIES"]
